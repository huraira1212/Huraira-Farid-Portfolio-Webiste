          ...
          <div className="content flexSB">
            <div className="left w-half">
              <div className="hero-content-box">
                <span className="hero-sub-title">I am Huraira Farid</span>
                <h1 className="hero-title">Web Developer + MERN Stack</h1>
                ...
                <div className="button-box flexG">
                  <a
                    href="https://europa.eu/europass/eportfolio/screen/share/551026b7-a774-4720-a574-2c59b327c946?lang=en"
            ...
            <div className="right w-half ">
              <div className="hero-image-box text-center mt-3">
